...
export type DashboardSnapshot = { generatedAt: string; source: "demo" | "live"; cases: RingCase[]; metrics: { precision: number; recall: number; f1: number; falsePositiveReviewRate: number; heldOutRings: number } };
